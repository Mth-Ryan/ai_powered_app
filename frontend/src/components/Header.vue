    ...
    <div class="container flex justify-between h-14 max-w-screen-2xl items-center">
      <div class="mr-6 flex">
        <a href="/" class="mr-6 flex items-center space-x-4">
          <Languages class="size-6 text-emerald-600" />
          <span class="font-bold"> AI Translator </span>
        </a>
      </div>
      <div class="flex items-center justify-end space-x-4">
        <div class="flex items-center gap-x-1">
          <a
            ...
            href="https://github.com/Mth-Ryan/ai_powered_app" target="_blank"><!--[-->
            <svg viewBox="0 0 15 15" width="1.2em" height="1.2em" class="w-[20px] h-5">
